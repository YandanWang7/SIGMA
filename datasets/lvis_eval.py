...
# Older lvis releases still reference deprecated NumPy aliases such as
# np.float during accumulation. Restore the alias for compatibility with
# modern NumPy versions.
...
class LvisEvaluator(object):
    ...
    def synchronize_between_processes(self):
        for iou_type in self.iou_types:
            ...
            self.coco_eval[iou_type], self._result[iou_type] = _evaluate_predictions_on_lvis(self.coco_gt, predictions,
                                                                                             iou_type, self.use_cats)
